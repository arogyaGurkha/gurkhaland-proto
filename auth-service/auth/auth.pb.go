...
type AuthRequest struct {
	...
	AuthReq *Auth `protobuf:"bytes,1,opt,name=authReq,proto3" json:"authReq,omitempty"`
}
...
func (x *AuthRequest) GetAuthReq() *Auth {
	if x != nil {
		return x.AuthReq
	}
	return nil
...
func (x *AuthResponse) GetData() *User {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x38, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x65,
	...
	0x61, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e,
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x52, 0x07, 0x61, 0x75, 0x74, 0x68, 0x52,
	0x65, 0x71, 0x22, 0xf6, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x46, 0x0a, 0x0c, 0x41,
	...
	0x75, 0x6c, 0x74, 0x12, 0x1e, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0a, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x32, 0x44, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x61, 0x75,
...
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthRequest.authReq:type_name -> auth.Auth
	4, // 1: auth.User.created_at:type_name -> google.protobuf.Timestamp
	4, // 2: auth.User.updated_at:type_name -> google.protobuf.Timestamp
	2, // 3: auth.AuthResponse.data:type_name -> auth.User
	1, // 4: auth.AuthService.Authenticate:input_type -> auth.AuthRequest
	3, // 5: auth.AuthService.Authenticate:output_type -> auth.AuthResponse
